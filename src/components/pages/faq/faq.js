    ...
    return (
      <Container className="container padding-medium-large">
        <Row className="default-margin  ">
          <Col
            className={
              "faq-main-heading d-flex flex-column justify-content-center justify-items-center text-center pt-5  "
            }
            lg={12}
            md={12}
            sm={12}
          >
            ...
            <span className=" justify-self-center pt-3 rise-text">
          ...
          <Col lg={12} md={12} sm={12}>
            <Row className=" faq-box">
              <Col
                className={
                  "faq-sub-heading d-flex flex-column justify-content-flex-start     "
                }
                lg={12}
                md={12}
                sm={12}
              ...
              <Col
                className={
                  " default-margin   d-flex   justify-content-flex-start     "
                }
                lg={12}
                md={12}
                sm={12}
