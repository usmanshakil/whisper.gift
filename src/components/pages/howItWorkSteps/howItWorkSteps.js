...
export default function HowItWorkSteps() {
    ...
    return (
        <div className="container padding-medium-large mb-3">
            {/* desktop view  */}
            <div className="  howItWorkSteps-dektop pt-4">
                <Row className="default-margin ">
                    {/* ist */}
                    <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area "} lg={4} md={4} sm={12}>
                        <Row className="default-margin">
                            <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area mb-5"} lg={12} md={12} sm={12}>
                                <span>{stepsData[1].text}   </span>
                            </Col>
                            <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area mt-5"} lg={12} md={12} sm={12}>
                                <span> {stepsData[2].text} </span>
                            </Col>
                        </Row>
                    ...
                    {/* 2nd */}
                    <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-image-area "} lg={4} md={4} sm={4}>
                        <Row className="default-margin">
                            <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area "} lg={12} md={12} sm={12}>
                                <span>{stepsData[0].text} </span>
                            </Col>
                            <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area "} lg={12} md={12} sm={12}>
                                <img className="twoColumWithImageAndText-image" alt="hero" src={IllustrationPNG} />
                            </Col>
                            <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area "} lg={12} md={12} sm={12}>
                                <span> {stepsData[3].text} </span>
                            </Col>
                        </Row>
                    ...
                    <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area "} lg={4} md={4} sm={12}>
                        <Row className="default-margin">
                            <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area mb-4"} lg={12} md={12} sm={12}>
                                <span> {stepsData[5].text} </span>
                            </Col>
                            <Col className={"d-flex flex-column justify-content-center align-items-center howItWorkSteps-text-area mt-4"} lg={12} md={12} sm={12}>
                                <span> {stepsData[4].text} </span>
                            </Col>
                        </Row>
                    </Col>
                </Row>
